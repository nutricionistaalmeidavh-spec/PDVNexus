...
contextBridge.exposeInMainWorld("nexusDesktop", {
  ...
  pdvCatalog: {
    list: (storeKey) => ipcRenderer.invoke("nexus-pdv-catalog:list", storeKey),
    save: (storeKey, product, previousProductCode) => ipcRenderer.invoke("nexus-pdv-catalog:save", storeKey, product, previousProductCode),
    remove: (storeKey, productCode) => ipcRenderer.invoke("nexus-pdv-catalog:remove", storeKey, productCode),
    replace: (storeKey, products) => ipcRenderer.invoke("nexus-pdv-catalog:replace", storeKey, products)
  },
  store: {
